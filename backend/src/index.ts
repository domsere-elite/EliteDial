...
// ─── Rate limiting — scoped to /api/auth/register only ─────────────
// /api/auth/me is the live "who am I" endpoint and gets hammered by useAuth on
// every mount + every Supabase auth-state change. Rate-limiting it would
// cascade into "looks like login failed" UX. Keep the strict limit on the
// account-creation route only.
